  ...
  return (
    <div className=" mx-auto">
      <div className="w-full fixed ">
        <div className="justify-between rounded-b-3xl  backdrop-blur-xl px-4 mx-auto md:items-center md:flex">
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              <Link href="/">
                <div className="justify-start flex space-x-2">
                  <TheCodeBirdLogo />
                  <p className="text-2xl p-1 font-bold">CodeBird</p>
                </div>
              </Link>

              <div className="md:hidden flex space-x-1">
                <div className="p-2">
                  <div className="mx-auto">{renderThemeChanger()}</div>
                </div>
                <div className="p-2">
          ...
          <div>
            ...
            >
              <ul className="items-center text-center justify-center space-y-8 md:flex md:space-x-4 md:space-y-0">
                <li>
                  <Link href="/">
                    <p className="w-fit mx-auto rounded-tl-3xl hover:outline hover:outline-gray-400 rounded-br-3xl px-3 py-1 duration-500">
                      &#60; Home &#47; &#62;
                    </p>
                  </Link>
                </li>
                ...
                <li className="hidden md:block md:border-l-2 pl-6 border-black dark:border-white">
                  <FaRegUserCircle className="w-8 h-8" />
                </li>
