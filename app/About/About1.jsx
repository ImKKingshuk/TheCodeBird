  ...
  return (
    <div className="py-[10rem]">
      ...
      <div className="pt-12 mx-auto">
        {
          <div className="w-[16rem] h-fit hover:shadow-2xl duration-500 p-1 mx-auto rounded-xl bg-gradient-to-br from-orange-400 via-gray-300 to-green-500">
            <div className=" bg-white dark:bg-slate-700 rounded-xl">
              <div className="mx-auto p-1">
                ...
                <h1 className="text-md pt-4 text-center font-medium">
                  Sumit Gupta &#40;SGP&#41; <br />{" "}
                  <span className="text-sm italic">Advisor / Professor</span>
                </h1>
        ...
        <div className="pt-[8rem] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 mx-auto gap-6 md:gap-12">
            {
              <div className="w-[16rem] h-fit hover:shadow-2xl duration-500 p-1 mx-auto rounded-xl bg-gradient-to-br from-orange-400 via-gray-300 to-green-500">
                <div className=" bg-white dark:bg-slate-700 rounded-xl">
                  <div className="mx-auto p-1">
                    ...
                    <h1 className="text-md pt-4 text-center font-medium">
                      @ImKKingshuk <br />{" "}
                      <span className="text-sm italic">Developer</span>
                    </h1>
                    <div className="pt-3 flex justify-center space-x-6 mx-auto">
                      <a href="#" className="  hover:scale-125 duration-500">
                        <span className="sr-only">Facebook</span>
